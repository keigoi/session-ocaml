...
(* OASIS_START *)
(* DO NOT EDIT (digest: 51e2c174ec6067b2229b66b45359b3e6) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Session"; "UnixAdapter"];
                      lib_pack = false;
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ppx_lens"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "session-ocaml";
                      lib_findlib_name = Some "ppx_lens";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\161\016\018\019\254\192v\214@R\025\191\2444{\131";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
