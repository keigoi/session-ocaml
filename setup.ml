...
(* OASIS_START *)
(* DO NOT EDIT (digest: f1a7291c7169e834a257badd9bca84e0) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the Lwt submodule";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Library
                 ({
                     cs_name = "session_ocaml";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_nativeopt =
                        [(OASISExpr.EBool true, ["-I"; "+threads"; "-O3"])]
                   },
                   {
                      lib_modules = ["Base"; "Direct"; "Net"; "Synchronous"];
                      lib_pack = true;
                      lib_internal_modules =
                        ["Channel"; "Dchannel"; "Unsafe"];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Session_ocaml_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "session_ocaml";
     ...
     oasis_digest = Some "\171*\228\024\006\179l88r\"\167b\019\1974";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
