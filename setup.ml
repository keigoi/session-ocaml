...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8161a6f4bd6144a9b38bf0cdf4a30f82) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_byteopt = [(OASISExpr.EBool true, ["-rectypes"])];
                      bs_nativeopt = [(OASISExpr.EBool true, ["-rectypes"])]
                   },
                   {
                      lib_modules = ["Session"; "UnixAdapter"; "Multiparty"];
                      lib_pack = false;
                      lib_internal_modules = ["Channel"; "Monitor"];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ppx_session"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "session-ocaml";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_session_ex.ml"});
               Executable
                 ({
                     cs_name = "myscribble";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "myscribble_ex.ml"})
            ];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\226\240x-\015\130\150a\195#}\180\236(\148y";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
