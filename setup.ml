...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1e59cea007999a33200ccddfd69c994c) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Session"; "UnixAdapter"; "Lsession"];
                      lib_pack = false;
                      lib_internal_modules =
                        ["Schannel"; "Channel"; "Monitor"];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("threads", None);
                           FindlibPackage ("str", None);
                           FindlibPackage ("ppx_implicits", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                      ...
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt =
                        [(OASISExpr.EBool true, ["-I"; "+threads"])];
                      bs_nativeopt =
                        [(OASISExpr.EBool true, ["-I"; "+threads"])]
                   },
                   {
                      lib_modules = ["Dsession"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "session-ocaml";
                      lib_findlib_name = Some "net";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
     ...
     oasis_digest = Some "\143s\192T9K]\199\167\197d\240\247\141\028p";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
